...
def test_phones_on_home_page(app):
    contact_from_home_page = app.contactHelper.get_contact_list()[0]
    contact_from_edit_page = app.contactHelper.get_contact_info_from_edit_page(0)
...
def test_phones_on_contacts_view_page(app):
    contact_from_view_page = app.contactHelper.get_contact_from_view_page(0)
    contact_from_edit_page = app.contactHelper.get_contact_info_from_edit_page(0)
